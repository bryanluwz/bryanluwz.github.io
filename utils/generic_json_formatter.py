...
if __name__ == "__main__":
    ...
    uni_stuff_json_formatter.set_json_file_path(
        r'C:\Users\bryan\Documents\GitHub\bryanluwz.github.io\src\main\extrasStuff.json')
    uni_stuff_json_formatter.set_input_folder_path(
        r'C:\Users\bryan\Documents\GitHub\bryanluwz.github.io\src\markdowns\extras-stuff')
    uni_stuff_json_formatter.update_json(mainKey='extras-stuff')
